/*
    Project: ELG5301 Professional Development Workshops CEED Project

    Description:
        Fingerprint attendance system using Arduino

    Owner:
        Anurag Singh (asing206@uottawa.ca)
        Arif Rubayet (aruba055@uottawa.ca)
        Radha Krishnan Swamynathan (rswam023@uottawa.ca)
        Raha Salimi (fsali050@uottawa.ca)
        Rajinder Sambhi (rsamb046@uottawa.ca)
    History:
        1.0   DGD1-Peer-Group-7  "Initial version"  2021-04-13
*/
...
void setup() {
    ...
    if (finger.verifyPassword()) {
        Serial.println("Successfully detected fingerprint sensor!");
    } else {
        Serial.println("Error in detecting fingerprint sensor!!!");
        while (1) {
            delay(1);
        }
    }
